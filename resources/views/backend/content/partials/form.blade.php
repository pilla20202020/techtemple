                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="" class="col-form-label pt-0">Title</label>
                                    <div class="">
                                        <input class="form-control" type="text" required name="title" value="{{ old('title', isset($content->title) ? $content->title : '') }}" placeholder="Enter Title">
                                    </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea name="content" id=""
                                          class="ckeditor">{{old('content',isset($content->content)?$content->content : '')}}</textarea>
                    ...
                    <div id="accordion1-1" class="collapse in">
                        <div class="card-actionbar">
                            <div class="card-actionbar-row">
                                <a class="btn btn-default btn-ink" href="{{ route('content.index') }}">
                            ...
                            <div class="side-label">
                                ...
                                <div class="label-body">
                                    <input type="checkbox" id="switch_demo_1" name="is_published"
                                           {{ old('is_published', isset($content->is_published) ? $content->is_published : '')=='1' ? 'checked':'' }} data-switchery/>
                                </div>
                            </div>
                            <div class="side-label">
                                <div class="label-head">
                                ...
                                <div class="label-body">
                                    <input type="checkbox" id="switch_demo_1" name="is_featured"
                                           {{ old('is_featured', isset($content->is_featured) ? $content->is_featured : '')=='1' ? 'checked':'' }} data-switchery/>
                                </div>
                            </div>
